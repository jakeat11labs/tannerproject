...
> 💡 Click any sample to open it in a new tab — your browser's native audio player will play it. **Or visit the [showcase page at jakeat11labs.github.io/tannerproject](https://jakeat11labs.github.io/tannerproject/) — players right in the page, paired with each sample.**
